					...
					echo '<div class="sj_vm_deals_popup sj_absolute">';
						...
						if ($params->get('item_quickview_display', 1) == 1) {
							echo '<div class="item-quick-view">';
								echo '<a href="'.$list[0]->link.'" title="'.$list[0]->title.'" '.VMDealsPHelper::parseTarget($params->get('link_target')).' style="display:none;">';  
							echo '</div>';
						} 
					echo '</div>';
				}
			...
			echo '<div class="item">';
				...
				if($params->get('item_popup_display') == 1){
					echo '<div class="sj_vm_deals_popup sj_absolute">';
						...
						if ($params->get('item_quickview_display', 1) == 1) {
							echo '<div class="item-quick-view">';
								echo '<a href="'.$item->link.'" title="'.$item->title.'" '.VMDealsPHelper::parseTarget($params->get('link_target')).' style="display:none;">';  
							echo '</div>';
						} 
					echo '</div>';
				}
