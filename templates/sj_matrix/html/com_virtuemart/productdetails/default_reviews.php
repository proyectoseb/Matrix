...
if ($this->allowRating || $this->allowReview || $this->showRating || $this->showReview) {
    ...
    for( $num = 0; $num<=$maxrating; $num++ ) {
        $stars[] = '
                <span title="'.(vmText::_( "COM_VIRTUEMART_RATING_TITLE" ).$num.'/'.$maxrating).'" class="vmicon ratingbox" style="display:inline-block;width:'. 17*$maxrating.'px;">
                    <span class="stars-orange" style="width:'.(17*$num).'px">
                    </span>
                </span>';
    }

    echo '<div id="add-reviews" class="customer-reviews">';
            ...
            foreach ($this->rating_reviews as $review) {
                ...
                if (!empty($this->rating_reviews) && $review->published) {
                    ...
                    <div class="<?php echo $color ?>">
                        ...
                        <div class="info"><span class="bold"><?php echo $review->customer ?></span><span class="vote"><?php  echo $stars[(int)$review->review_rating] ?></span></div>
                    </div>
                    <?php
                }
                $i++;
