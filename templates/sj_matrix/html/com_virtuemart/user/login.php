    ...
    if ($this->order  ) {
	    ...
	    <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
			<div class="number-pass">
				<div class="width50 floatleft input-item" id="com-form-order-number">
				...
				<div class="width50 floatleft input-item" id="com-form-order-pass">
...
<?php   }
	...
	<?php }   ?>
		<div class="user-pass">
			<div class="width50 floatleft input-item" id="com-form-login-username">
				<input type="text" name="username" class="inputbox" size="18" placeholder="<?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?>" alt="<?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?>"  />
			</div>
	
			<div class="width50 floatleft input-item" id="com-form-login-password">
				<input id="modlgn-passwd" type="password" name="password" class="inputbox" size="18" placeholder="<?php echo vmText::_('COM_VIRTUEMART_PASSWORD'); ?>" alt="<?php echo vmText::_('COM_VIRTUEMART_PASSWORD'); ?>" />
			</div>
		</div>
        <div class="width50 floatleft" id="com-form-login-remember">
