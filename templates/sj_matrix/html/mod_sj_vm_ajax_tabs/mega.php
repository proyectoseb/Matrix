...
$uniqueid = 'vm_ajaxtabs_' . rand() . time();
...
if ($list != null) {
	foreach ($list as $first_category) {
		$category_preload = $first_category->virtuemart_category_id;
		break;
	}
	...
	<!--[if lt IE 9]>
	<div class="sj-vm-ajax-tabs <?php echo $css_posiotion?> msie lt-ie9" id="<?php echo $uniqueid; ?>"><![endif]-->
	<!--[if IE 9]>
	<div class="sj-vm-ajax-tabs <?php echo $css_posiotion?> msie" id="<?php echo $uniqueid; ?>"><![endif]-->
	<!--[if gt IE 9]><!-->
	<div class="sj-vm-ajax-tabs <?php echo $css_posiotion?>" id="<?php echo $uniqueid; ?>"><!--<![endif]-->
		<div class="yt-wrap">
		<?php
		...
		?>>
			<div class="tabs-content-inner">
				...
				foreach ($list as $category):
					...
					$is_preload = $category->virtuemart_category_id == $category_preload;
					$css_selected = $is_preload ? "tab-content  category-id-{$category->virtuemart_category_id} selected" : "tab-content category-id-{$category->virtuemart_category_id}"; ?>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function ($) {
			...
			$("#<?php echo $module->id;?> .item-wrap .item-rating").each(function(){
				var item = $(this);
