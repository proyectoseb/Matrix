	...
	<div class="mc-wrap"><!-- Begin mc-wrap -->
		...
		<div class="mc-header">
			<div class="mc-yourcart">
				<?php echo  '<span class="count-item">'.JText::_('YOUR_CART_VM').'</span><br/><span class="count-price">'.count($cart->products).' '.JText::_('ITEMS').$cart->billTotal.'</span>'; ?>			
			</div>
		</div>
				...
				<?php if ($options->goto_cart_display == 1 || $options->checkout_display == 1 || $options->total_price_display == 1) { ?>
					<div class="mc-footer">
						...
						<?php if ($options->total_price_display == 1) { ?>
							...
							<?php echo $cart->billTotal_Footer ?>
							</span>
						<?php } ?>
						</div>
