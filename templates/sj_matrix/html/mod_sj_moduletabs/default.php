...
$themes = JFactory::getApplication()->getTemplate();
JHtml::stylesheet('templates/'.$themes.'/html/mod_sj_moduletabs/css/moduletabs.css');
...
<?php ob_start(); ?>
	<div class="tabs-container">
		...
		?>
			...
			<li class="span<?php echo 12/count($listmodules)?>"><div class="<?php echo $css_selected; ?>"><?php echo $_module->title ?></div></li>
		<?php 
			}
		?>
		</ul>
