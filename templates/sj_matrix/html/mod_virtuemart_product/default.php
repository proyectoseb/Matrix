	...
	if ($display_style == "div") {
		...
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>">
				<div class="spacer">
					<div class="label label-warning"><?php echo $id = $id+1;?></div>
					...
					<a class="title" href="<?php echo $url ?>"><?php echo $product->product_name ?></a>
					<?php
					echo shopFunctionsF::renderVmSubLayout('rating',array('showRating'=> 1,'product'=> $product));
					if ($show_price) {
		...
		<ul class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<li class="<?php echo $pwidth ?> <?php echo $float ?>">
				...
				$url = JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' .
					$product->virtuemart_category_id); ?>
				<a class="title" href="<?php echo $url ?>"><?php echo $product->product_name ?></a>        <?php    echo '<div class="clear"></div>';
