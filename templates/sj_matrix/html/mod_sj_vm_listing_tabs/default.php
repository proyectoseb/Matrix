        ...
        <div class="ltabs-wrap ">
            ...
            <div class="ltabs-items-container"><!--Begin Items-->
                ...
                <div class="ltabs-items <?php echo $cls; ?>" data-total="<?php echo $params->get('type_show') == 'slider' ?  floor($items->count/$nb_rows) : $items->count ;?>">
                    ...
                    <?php } ?>
                <?php
				$caturl = JRoute::_('index.php?option=com_virtuemart&view=category&virtuemart_category_id=' . $items->virtuemart_category_id); 
                ...
                <div class="ltabs-loadmore"
					...
					<?php if(($classloaded)){?>
						<a  href="<?php echo $caturl; ?>" > <?php echo JText::_('ALL_READY_LABEL') ?> </a>
					<?php }else { ?>
						<div class="ltabs-loadmore-btn  <?php echo $classloaded ?>" data-label="<?php echo JText::_('VIEW_ALL_PRODUCT') ?>">
						</div>
