        ...
        <div class="ltabs-item new-ltabs-item">
            ...
            <div class="item-inner">
                ...
                <?php if (($params->get('item_title_display', 1) == 1) ||
                        ((int)$params->get('item_prices_display', 1) && ( !empty($item->prices['salesPrice']) || !empty($item->prices['salesPriceWithDiscount'])) ) ||
                        ((int)$params->get('item_description_display', 1) && VMListingTabsHelper::_trimEncode($item->_description) != '') ||
                        ($params->get('item_created_display', 1) == 1) ||
                        ($params->get('item_readmore_display') == 1) ||
                        ($params->get('item_addtocart_display', 1)))
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            var $tag_id = $('#sj_listing_tabs_<?php echo $module->id; ?>'),
                parent_active = 	$('.items-category-<?php echo $tab_id; ?>', $tag_id),
                total_product = parent_active.data('total'),
                tab_active = $('.ltabs-tabs-wrap .ltabs-tabs'),
                nb_column1 = <?php echo $params->get('nb-column1'); ?>,
                nb_column2 = <?php echo $params->get('nb-column2'); ?>,
                nb_column3 = <?php echo $params->get('nb-column3'); ?>,
                nb_column4 = <?php echo $params->get('nb-column4'); ?>;
