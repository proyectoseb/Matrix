...
$autoplayTimeout = ((int)$options->autoplayTimeout > 0 ) ? (int)$options->autoplayTimeout : 5000;
$autoplayHoverPause = ($options->autoplayHoverPause == 1) ? 'true' : 'false';
$autoplaySpeed = ((int)$options->autoplaySpeed > 0 ) ? (int)$options->autoplaySpeed : 3000;
$navSpeed = ((int)$options->navSpeed > 0 ) ? (int)$options->navSpeed : 3000;
