	...
	$(".yt_shortcode_element").click(function(){
		...
		$.ajax({
			...
			success: function (data) {
				...
				$('.yt_shortcodes_parent_form_element .yt-generator-field-container').each(function () {
				var group = $(this).data('group');
				// Show choice if matched
				if (group =="all" || group == $(".yt_shortcodes_parent_form_element #yt-generator-attr-type_change").val())
				{
					$(this).show();
				}else{
					$(this).hide();
				...
				$("#yt-generator-attr-type_change").change(function(){
					...
					// Hide all choices
					$('.yt_shortcodes_parent_form_element .yt-generator-field-container').hide();
					// Find searched choices and show
					$('.yt_shortcodes_parent_form_element .yt-generator-field-container').each(function () {
						// Get shortcode name
						var group = $(this).data('group');
